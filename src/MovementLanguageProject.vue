  ...
  <main class="case-study">
    ...
    <article>
      ...
      <section class="data-pipeline">
        <div class="shell">
          <div class="section-copy"><p class="kicker">10 · From records to evidence</p><h2>Cleaning and coding were part of the research—not a hidden step.</h2><p>The analysis kept raw descriptions separate from researcher interpretation, preserved presentation order, and documented each revision from open coding to final aggregation.</p></div>
